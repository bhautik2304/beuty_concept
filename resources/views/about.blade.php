  ...
  <section id="tabs" class="text-center">
    <nav>
      <div class="nav nav-tabs " id="nav-tab" role="tablist">
        ...
        <button class="nav-link active" id="nav-second-tab" data-bs-toggle="tab" data-bs-target="#nav-second"
          type="button" role="tab" aria-controls="nav-second" aria-selected="false">
          Luxury
        </button>
        <button class="nav-link" id="nav-third-tab" data-bs-toggle="tab" data-bs-target="#nav-third" type="button"
          role="tab" aria-controls="nav-third" aria-selected="false">
          Prestige
        </button>
        <button class="nav-link" id="nav-fourth-tab" data-bs-toggle="tab" data-bs-target="#nav-fourth" type="button"
          role="tab" aria-controls="nav-fourth" aria-selected="false">
          Popular
        </button>
        <button class="nav-link" id="nav-fifth-tab" data-bs-toggle="tab" data-bs-target="#nav-fifth" type="button"
          role="tab" aria-controls="nav-fifth" aria-selected="false">
          Fashion
        </button>
        <button class="nav-link" id="nav-sixth-tab" data-bs-toggle="tab" data-bs-target="#nav-sixth" type="button"
          role="tab" aria-controls="nav-sixth" aria-selected="false">
          Lifestyle
        </button>
      </div>
    </nav>
    ...
    <div class="row">
      ...
      <div class="col-md-6 pe-5 pt-2">
        ...
        <p>Becoming India’s Leading Distribution House for Lifestyle & Fashion Accessories.
          <br><br>
          Our mission is to partner with select global companies that aim to build their brand and distribution
          network in India and deliver extraordinary fragrance and beauty products to consumers in India. We believe
          in long term association and creation of value through mutual respect and understanding, trust and
          ...
          <br><br>
          As an organisation, and as individuals, we value honesty, integrity, empowerment and openness. By
          consistently aiming for breakthrough excellence in creation, design and experience, we believe we will stay
          close to our consumers and communities.
        </p>
      </div>
    </div>
    <div class="row mt-5">
